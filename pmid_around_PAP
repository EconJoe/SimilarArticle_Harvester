...
#https://github.com/EconJoe/SimilarArticle_Harvester/blob/master/pmc_pmid_similararticles.py
...
all_pmids = pd.read_csv(directory + 'pmid_list_around_PAP.csv', dtype={'pmid': object})
...
all_pmids_split = np.array_split(all_pmids, 50)
